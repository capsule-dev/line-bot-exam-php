...
#ตัวอย่าง Message Type "Text" '''
    if($message == "Message"){
        ...
        $arrayPostData['messages'][0]['contents']['body']['contents'][0]['contents'][2]['type'] = "image";
        $arrayPostData['messages'][0]['contents']['body']['contents'][0]['contents'][2]['url'] = "https://www.linefriends.com/img/img_sec.jpg";
        $arrayPostData['messages'][0]['contents']['body']['contents'][0]['contents'][2]['size'] = "full";
